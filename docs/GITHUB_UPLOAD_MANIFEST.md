...
- `docs/UI_AGENT_MODE.md`
- `docs/USER_EXPORT_PARSERS.md`
- `docs/VM_HANDOFF.md`
...
- `src/TiaPortalAgenticToolkit.Openness/ImportPackGenerator.cs`
- `src/TiaPortalAgenticToolkit.Openness/OfflineExportAnalyzer.cs`
- `src/TiaPortalAgenticToolkit.Openness/TiaArtifactParsers.cs`
- `src/TiaPortalAgenticToolkit.Openness/TemplatePackGenerator.cs`
- `src/TiaPortalAgenticToolkit.Openness/TiaPortalSession.cs`
- `src/TiaPortalAgenticToolkit.Openness/UiAgentPlanner.cs`
...
- `templates/tia-portal/base-v16-experimental/README.md`
- `templates/tia-portal/base-v16-experimental/experimental-import-map.json`
- `templates/tia-portal/base-v16-experimental/fbd-axis-mode.robot.xml`
- `templates/tia-portal/base-v16-experimental/hmi-axis-overview.robot.json`
- `templates/tia-portal/base-v16-experimental/lad-axis-interlock.robot.xml`
- `templates/tia-portal/base-v16-experimental/plc-tags-suggested.csv`
- `testdata/generated-axis-pack/01_UDT_AxisCommand.scl`
- `testdata/generated-axis-pack/02_UDT_AxisStatus.scl`
- `testdata/generated-axis-pack/03_DB_AxisData.scl`
- `testdata/generated-axis-pack/04_FB_AxisControl.scl`
- `testdata/generated-axis-pack/05_OB1_Call_Example.scl`
- `testdata/generated-axis-pack/HMI_Screen_Plan.md`
- `testdata/generated-axis-pack/MANUAL_IMPORT_CHECKLIST.md`
- `testdata/generated-axis-pack/PLC_Tags_Suggested.csv`
- `testdata/generated-axis-pack/Practice_Report.md`
- `testdata/generated-axis-pack/manifest.json`
